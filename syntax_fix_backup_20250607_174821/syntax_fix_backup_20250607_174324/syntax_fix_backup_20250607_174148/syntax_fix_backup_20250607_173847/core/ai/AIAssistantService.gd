...
const GeminiAIServiceClass = prepreprepreload("res://core/ai/GeminiAIService.gd")
...
## @returns: Array of provider names
	...
	match question_type:
		...
		"clinical":
			structured_question = (
				"What are the clinical implications of %s dysfunction or damage?"
				% current_structure
			)
		_:
			structured_question = "Tell me about the " + current_structure
