...
func _ready() -> void:
    ...
    var components = {
        "MainSceneOrchestrator": load("res://scenes/main/components/MainSceneOrchestrator.gd"),
        "DebugManager": load("res://scenes/main/components/DebugManager.gd"),
        "SelectionCoordinator": load("res://scenes/main/components/SelectionCoordinator.gd"),
        "UICoordinator": load("res://scenes/main/components/UICoordinator.gd"),
        "AICoordinator": load("res://scenes/main/components/AICoordinator.gd")
    }
    ...
    print("   - Has _register_debug_commands: %s" % debug_mgr.has_method("_register_debug_commands"))
    ...
    print("   - Has _initialize_selection_system: %s" % selection.has_method("_initialize_selection_system"))
