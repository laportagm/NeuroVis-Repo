...
# === PRELOADS ===
const ICON_EYE = preload("res://assets/icons/eye.svg") if FileAccess.file_exists("res://assets/icons/eye.svg") else null
const ICON_MOTION = preload("res://assets/icons/motion.svg") if FileAccess.file_exists("res://assets/icons/motion.svg") else null
const ICON_CONTRAST = preload("res://assets/icons/contrast.svg") if FileAccess.file_exists("res://assets/icons/contrast.svg") else null
