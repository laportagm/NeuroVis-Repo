...
@onready var structure_container: VBoxContainer = $VBox/ScrollContainer/ContentVBox/StructureContainer
@onready var relationship_container: VBoxContainer = $VBox/ScrollContainer/ContentVBox/RelationshipContainer
