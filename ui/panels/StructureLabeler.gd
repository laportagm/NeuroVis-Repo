...
# FIXED: Orphaned code - var display_name = structure_id  # Default if not found
var structure_data = knowledge_base.get_structure(structure_id)
# FIXED: Orphaned code - var label = Label3D.new()
...
# FIXED: Orphaned code - var count = label_count
