...
var steps = [
    ...
    },
    {
        ...
        "description": "Click and drag to orbit around the brain model. Use your mouse to explore different angles.",
        "action": "orbit",
        "gesture": "drag"
    },
    {
        "title": "Zoom In & Out",
        "description": "Use your scroll wheel or trackpad to zoom in and out for detailed examination.",
        "action": "zoom",
        "gesture": "scroll"
    },
    {
...
func _create_modern_button(text: String, color: Color) -> Button:
    ...
    btn.add_theme_color_override("font_color", Color.WHITE if color != Color("#B8BCC8") else Color.BLACK)
