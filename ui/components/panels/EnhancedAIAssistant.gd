...
# === EDUCATIONAL MODES ===
enum EducationalMode {
    BEGINNER,      # Simple language, basic concepts
    STUDENT,       # Medical/science student level
    PROFESSIONAL,  # Healthcare professional level
    RESEARCH,      # Advanced research level
    QUICK_FACTS    # Bullet points, concise info
}
...
enum QuestionType {
    ...
    COMPARISON,    # Compare structures
    PATHWAY,       # Neural pathways
    DEVELOPMENT,   # Developmental aspects
...
func _create_chat_area() -> ScrollContainer:
    ...
    # Add welcome message
    _add_system_message("Hello! I'm your AI assistant for learning about brain anatomy. Select a structure and ask me anything!")
...
func _detect_question_type(question: String) -> QuestionType:
    ...
    elif "disease" in lower_question or "disorder" in lower_question or "clinical" in lower_question:
...
func _on_settings_pressed() -> void:
    ...
    suggest_check.toggled.connect(func(pressed): 
...
func _get_mode_name(mode: EducationalMode) -> String:
    ...
    match mode:
        ...
        EducationalMode.PROFESSIONAL: return "Professional"
        EducationalMode.RESEARCH: return "Research"
        EducationalMode.QUICK_FACTS: return "Quick Facts"
        _: return "Unknown"
...
func _on_language_changed(index: int) -> void:
    ...
    match index:
        ...
        2: current_language = "fr"
        3: current_language = "de"
