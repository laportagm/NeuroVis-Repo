...
func _update_description_section(data: Dictionary) -> void:
	...
	var description = data.get("shortDescription", data.get("description", "No description available."))
...
func _format_clinical_notes(clinical_text: String) -> String:
	...
	var clinical_keywords = ["pathology", "disease", "disorder", "syndrome", "damage", "lesion", "dysfunction"]
