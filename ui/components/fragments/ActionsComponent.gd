...
func apply_preset(preset_name: String) -> void:
	...
	match preset_name:
		...
		"research":
			configure_actions({
				"buttons": [
					{"action": "bookmark", "text": "Bookmark", "icon": "⭐", "type": "secondary"},
		...
		"clinical":
			configure_actions({
				"buttons": [
					{"action": "pathology", "text": "Pathology", "icon": "🔬", "type": "primary"},
					{"action": "symptoms", "text": "Symptoms", "icon": "📋", "type": "secondary"},
					{"action": "treatment", "text": "Treatment", "icon": "💊", "type": "secondary"}
				]
			})
