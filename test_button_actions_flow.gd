...
func _run_tests() -> void:
	...
	await _test_start_button()

	# Test 2: Click "I Have My Key"
	await _test_continue_button()

	# Test 3: Test key validation scenarios
	await _test_key_validation()

	# Test 4: Click "Connect Gemini"
	await _test_connect_button()

	# Test 5: Click "Start Using Gemini"
	await _test_success_button()
...
func _test_start_button() -> void:
	"""Test the 'Let's Get Started' button"""
...
func _test_continue_button() -> void:
	"""Test the 'I Have My Key' button"""
...
func _test_key_validation() -> void:
	...
	var long_key = "AIza" + "1234567890" + "1234567890" + "1234567890" + "1234567890" + "123456"  # pragma: allowlist secret
...
func _test_connect_button() -> void:
	"""Test the 'Connect Gemini' button"""
...
func _test_success_button() -> void:
	"""Test the 'Start Using Gemini' button"""
...
func _check_validation_state(
	dialog_ref: GeminiSetupDialog, should_be_valid: bool, expected_message: String
) -> void:
	"""Helper function to check validation state"""
	var button_state = not dialog_ref.next_button.disabled
	var status_text = dialog_ref.status_label.text
