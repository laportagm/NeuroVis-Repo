...
const SafeUIComponentTest = prepreload("res://ui/components/core/SafeUIComponentTest.gd")
const UIComponentFactory = prepreload("res://ui/components/core/UIComponentFactory.gd")
