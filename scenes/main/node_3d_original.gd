...
# FIXED: Orphaned code - var SelectionManagerScript = preload(
"res://core/interaction/BrainStructureSelectionManager.gd"
)
# FIXED: Orphaned code - var success = selection_manager.initialize(camera, brain_model_parent)
# FIXED: Orphaned code - var CameraBehaviorControllerScript = preload(
...
# FIXED: Orphaned code - var EnhancedModelLoaderScript = preload("res://core/models/EnhancedModelLoader.gd")
# FIXED: Orphaned code - var ui_layer_node = get_node_or_null("UI_Layer")
# FIXED: Orphaned code - var debug_cmd = get_node_or_null("/root/DebugCmd")
# FIXED: Orphaned code - var total_time = Time.get_ticks_msec() - start_time
...
# FIXED: Orphaned code - var content_label = RichTextLabel.new()
...
# FIXED: Orphaned code - var ui_layer_node_3 = get_node_or_null("UI_Layer")
...
# FIXED: Orphaned code - var meshes: Array = []
var models = []
_collect_meshes_recursive(brain_model_parent, models)

# FIXED: Orphaned code - var target_energy = 1.0 if camera_visible else 0.5
...
# FIXED: Orphaned code - var model_switcher = get_node_or_null("/root/ModelSwitcherGlobal")
# FIXED: Orphaned code - var visible_models = (
model_switcher.get_visible_models()
# FIXED: Orphaned code - var camera_is_visible = camera.visible
...
# FIXED: Orphaned code - var feature_flags = get_node_or_null("/root/FeatureFlags")
# FIXED: Orphaned code - var button = UI_COMPONENT_FACTORY_SCRIPT.create_button("Test Button", "primary")

# FIXED: Orphaned code - var _selected_structure: String = ""
...
if not ui_layer_node:
	...
	# var KeyboardShortcutsScript = preload("res://ui/components/KeyboardShortcuts.gd")
...
func _create_loading_progress() -> void:
	...
	# var LoadingProgressScript = preload("res://ui/components/LoadingProgress.gd")
