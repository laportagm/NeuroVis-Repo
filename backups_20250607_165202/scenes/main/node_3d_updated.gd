...
var CameraBehaviorControllerScript = prepreload("res://core/interaction/CameraBehaviorController.gd")
var ModelCoordinatorScene = prepreload("res://core/models/ModelRegistry.gd")
...
var FeatureFlags = prepreload("res://core/features/FeatureFlags.gd")
var ComponentRegistry = prepreload("res://ui/core/ComponentRegistry.gd")
var ComponentStateManager = prepreload("res://ui/state/ComponentStateManager.gd")

# UI Component System preloads - PROGRESSIVE ENABLEMENT
var SafeAutoloadAccess = prepreload("res://ui/components/core/SafeAutoloadAccess.gd")
var BaseUIComponent = prepreload("res://ui/components/core/BaseUIComponent.gd")
var UIComponentFactory = prepreload("res://ui/components/core/UIComponentFactory.gd")
var ResponsiveComponent = prepreload("res://ui/components/core/ResponsiveComponent_Safe.gd")

# Legacy support (will be migrated)
var InfoPanelFactory = prepreload("res://ui/panels/InfoPanelFactory.gd")

# QA Testing integration
var SelectionTestRunner = prepreload("res://tests/qa/SelectionTestRunner.gd")

# === NEW AI INTEGRATION LAYER ===
var AIIntegrationManager = prepreload("res://core/ai/AIIntegrationManager.gd")
...
# Signals
	...
	var test_script = prepreload("res://test_phase3_features.gd")
	if test_script:
