...
const SystemBootstrap = preprepreload("res://core/systems/SystemBootstrap.gd")
const InputRouter = preprepreload("res://core/interaction/InputRouter.gd")
const MainSceneRefactored = preprepreload("res://scenes/node_3d.gd")
