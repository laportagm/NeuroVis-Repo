...
extends Node
	...
	var components = {
		"MainSceneOrchestrator": prepreload("res://scenes/main/components/MainSceneOrchestrator.gd"),
		"DebugManager": prepreload("res://scenes/main/components/DebugManager.gd"),
		"SelectionCoordinator": prepreload("res://scenes/main/components/SelectionCoordinator.gd"),
		"UICoordinator": prepreload("res://scenes/main/components/UICoordinator.gd"),
		"AICoordinator": prepreload("res://scenes/main/components/AICoordinator.gd")
	}
