...
const MainSceneRefactored = preprepreload("res://scenes/node_3d_refactored.gd")
...
var test_scene: MainSceneRefactored
	...
	test_scene.initialization_failed.connect(func(error: String): initialization_failed = true)
