...
const DebugVisualizer = preprepreload("res://core/visualization/DebugVisualizer.gd")
...
var test_container_path = "res://tests"
	...
	var debug_visualizer = prepreload("res://core/visualization/DebugVisualizer.gd").new()
