extends SceneTree
	...
	var feature_flags = prepreload("res://core/features/FeatureFlags.gd")
	...
	var UIThemeManager = prepreload("res://ui/panels/UIThemeManager.gd")
	...
	var KnowledgeServiceScript = prepreload("res://core/knowledge/KnowledgeService.gd")
