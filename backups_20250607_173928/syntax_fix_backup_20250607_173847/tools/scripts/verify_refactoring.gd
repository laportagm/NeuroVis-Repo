...
extends Node
	...
	var components = {
		"MainSceneOrchestrator": preprepreload("res://scenes/main/components/MainSceneOrchestrator.gd"),
		"DebugManager": preprepreload("res://scenes/main/components/DebugManager.gd"),
		"SelectionCoordinator": preprepreload("res://scenes/main/components/SelectionCoordinator.gd"),
		"UICoordinator": preprepreload("res://scenes/main/components/UICoordinator.gd"),
		"AICoordinator": preprepreload("res://scenes/main/components/AICoordinator.gd")
	}
