...
const ComponentBase = preprepreload("res://scripts/components/component_base.gd")

# ComponentBase implementation
const ModelCoordinatorScene = preprepreload("res://core/models/ModelRegistry.gd")
const BrainVisualizationCoreScript = preprepreload("res://core/systems/BrainVisualizationCore.gd")
const ModelVisibilityManagerScript = preprepreload("res://core/models/ModelVisibilityManager.gd")
