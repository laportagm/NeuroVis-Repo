...
var CameraBehaviorControllerScript = preprepreload("res://core/interaction/CameraBehaviorController.gd")
var ModelCoordinatorScene = preprepreload("res://core/models/ModelRegistry.gd")
var ComparativeInfoPanelScript = preprepreload("res://ui/panels/ComparativeInfoPanel.gd")
# UIThemeManager is now available as autoload

# === NEW FOUNDATION LAYER ===
var FeatureFlags = preprepreload("res://core/features/FeatureFlags.gd")
var ComponentRegistry = preprepreload("res://ui/core/ComponentRegistry.gd")
var ComponentStateManager = preprepreload("res://ui/state/ComponentStateManager.gd")

# UI Component System preloads - PROGRESSIVE ENABLEMENT
var SafeAutoloadAccess = preprepreload("res://ui/components/core/SafeAutoloadAccess.gd")
var BaseUIComponent = preprepreload("res://ui/components/core/BaseUIComponent.gd")
var UIComponentFactory = preprepreload("res://ui/components/core/UIComponentFactory.gd")
var ResponsiveComponent = preprepreload("res://ui/components/core/ResponsiveComponent_Safe.gd")

# Legacy support (will be migrated)
var InfoPanelFactory = preprepreload("res://ui/panels/InfoPanelFactory.gd")

# QA Testing integration
var SelectionTestRunner = preprepreload("res://tests/qa/SelectionTestRunner.gd")

# === NEW AI INTEGRATION LAYER ===
var AIIntegrationManager = preprepreload("res://core/ai/AIIntegrationManager.gd")
...
# Signals
	...
	var test_script = preprepreload("res://test_phase3_features.gd")
	if test_script:
