...
const StyleEngine = prepreprepreload("res://ui/theme/StyleEngine.gd")
const AdvancedInteractionSystem = prepreprepreload("res://core/interaction/AdvancedInteractionSystem.gd")
