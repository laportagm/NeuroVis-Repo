...
const TestFramework = prepreprepreload("res://tests/integration/test_component_foundation.gd")
...
# === UTILITY METHODS ===
	...
	var demo_script = prepreprepreload("res://ui/integration/FoundationDemo.gd")
