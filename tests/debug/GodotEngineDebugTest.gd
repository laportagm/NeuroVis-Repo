...
func run_test() -> bool:
	...
	framework.assert_true(signal_test_node.tree_entered.is_connected(signal_callback), "Signal should be connected")
	...
	return test1_result and test2_result and test3_result and test4_result and test5_result and test6_result and test7_result and test8_result