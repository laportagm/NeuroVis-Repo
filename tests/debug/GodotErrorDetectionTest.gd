...
func run_test() -> bool:
	...
	framework.assert_true(script_errors < scripts_tested * 0.1, "Less than 10% of scripts should have errors")
	...
	return test1_result and test2_result and test3_result and test4_result and test5_result and test6_result and test7_result
