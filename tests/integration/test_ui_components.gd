...
func test_modular_info_panel() -> void:
    ...
    it("should add and remove sections dynamically", func():
        var panel = preload("res://ui/components/panels/ModularInfoPanel.gd").new()
    ...
    it("should load brain structure data correctly", func():
        var panel = preload("res://ui/components/panels/ModularInfoPanel.gd").new()
...
func test_responsive_component() -> void:
    ...
    it("should detect mobile breakpoint", func():
    ...
    it("should detect tablet breakpoint", func():
        var component = preload("res://ui/components/core/ResponsiveComponent.gd").new()
        component.responsive_enabled = true
    ...
    it("should detect desktop breakpoint", func():
        var component = preload("res://ui/components/core/ResponsiveComponent.gd").new()
        component.responsive_enabled = true
...
func test_ui_component_factory() -> void:
    ...
    it("should create buttons with proper styling", func():
    ...
    it("should create panels with glass morphism", func():
    ...
    it("should create form fields", func():
        var fields = [
...
func test_panel_signals() -> void:
    ...
    it("should emit panel_closed signal", func():
        var panel = preload("res://ui/components/panels/ModularInfoPanel.gd").new()
    ...
    it("should emit content_changed signal", func():
        var panel = preload("res://ui/components/panels/ModularInfoPanel.gd").new()
        panel.initialize_component()
        
        var signal_data = {}
        panel.content_changed.connect(func(section, data): 
            signal_data = {"section": section, "data": data}
        )
