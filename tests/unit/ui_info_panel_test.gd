...
# FIXED: Orphaned code - var test_structure_id = structure_ids[0]
var structure_data = knowledge_base.get_structure(test_structure_id)
# FIXED: Orphaned code - var structure_name_label = info_panel.get_node(
"MarginContainer/VBoxContainer/TitleBar/StructureName"
)
# FIXED: Orphaned code - var close_button = info_panel.get_node("MarginContainer/VBoxContainer/TitleBar/CloseButton")
...
# FIXED: Orphaned code - var second_structure_id = structure_ids[1]
