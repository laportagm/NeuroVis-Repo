...
func test_camera_shortcuts_handling():
	...
	test_router.camera_shortcut_triggered.connect(func(shortcut: String):
...
func test_selection_input_handling():
	...
	test_router.selection_attempted.connect(func(position: Vector2, button: int):
...
func test_hover_input_handling():
	...
	test_router.hover_position_changed.connect(func(position: Vector2):
		hover_changed = true
	)
...
func test_input_status_reporting():
	...
	assert_true(status.has("camera_shortcuts_enabled"), "Status should include camera_shortcuts_enabled")
	assert_true(status.has("selection_input_enabled"), "Status should include selection_input_enabled")
