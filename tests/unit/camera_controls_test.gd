...
func _create_mock_input_events() -> Array:
	...
	events.append({
		"event": left_event,
		"description": "Left arrow key press"
	})
	...
	events.append({
		"event": right_event,
		"description": "Right arrow key press"
	})
	...
	events.append({
		"event": up_event,
		"description": "Up arrow key press"
	})
	...
	events.append({
		"event": down_event,
		"description": "Down arrow key press"
	})
	...
	events.append({
		"event": zoom_in_event,
		"description": "E key press (zoom in)"
	})
	...
	events.append({
		"event": zoom_out_event,
		"description": "Q key press (zoom out)"
	})
	...
	events.append({
		...
		"description": "Mouse wheel scroll up (zoom in)"
	})
	...
	events.append({
		...
		"description": "Mouse wheel scroll down (zoom out)"
	})
	...
	events.append({
		"event": reset_event,
		"description": "R key press (reset camera)"
	})
