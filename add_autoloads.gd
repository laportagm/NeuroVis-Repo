...
func _run() -> void:
    ...
    # Add autoloads
    editor.get_editor_settings().set_setting("autoload/AIConfig", "res://core/ai/config/AIConfigurationManager.gd")
    editor.get_editor_settings().set_setting("autoload/AIRegistry", "res://core/ai/AIProviderRegistry.gd")
    editor.get_editor_settings().set_setting("autoload/AIIntegration", "res://core/ai/AIIntegrationManager.gd")
