...
func test_class_loading() -> void:
    ...
    results.append(test_class("AIProviderInterface", "res://core/ai/providers/AIProviderInterface.gd"))
    
    # Test AIConfigurationManager
    results.append(test_class("AIConfigurationManager", "res://core/ai/config/AIConfigurationManager.gd"))
