...
func _exit_tree() -> void:
	...
	if model_coordinator:
		# Disconnect signals
		if (
			model_coordinator.has_signal("models_loaded")
			and model_coordinator.models_loaded.is_connected(_on_coordinator_models_loaded)
		):
			model_coordinator.models_loaded.disconnect(_on_coordinator_models_loaded)
		if (
			model_coordinator.has_signal("model_load_failed")
			and model_coordinator.model_load_failed.is_connected(_on_coordinator_model_load_failed)
		):
