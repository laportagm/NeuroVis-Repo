...
func test_config_manager():
	...
	# Load class
	var AIConfigManagerScript = load("res://core/ai/config/AIConfigurationManager.gd")
...
func test_provider_registry():
	...
	# Load class
	var AIProviderRegistryScript = load("res://core/ai/AIProviderRegistry.gd")
...
func test_gemini_provider():
	...
	# Load class
	var GeminiAIProviderScript = load("res://core/ai/providers/GeminiAIProvider.gd")
