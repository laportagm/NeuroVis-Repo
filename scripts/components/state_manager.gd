...
func set_components(visualizer: BrainVisualizer, ui: UIManager, interaction: InteractionHandler) -> void:
...
func _get_custom_status() -> Dictionary:
	return {
		...
		"components_connected": brain_visualizer != null and ui_manager != null and interaction_handler != null
	}
