...
var nav_items = {
    "brain_regions": {
        "text": "Brain Regions",
        "icon": preload("res://assets/icons/brain.svg") if ResourceLoader.exists("res://assets/icons/brain.svg") else null
    },
    "neural_networks": {
        "text": "Neural Networks", 
        "icon": preload("res://assets/icons/network.svg") if ResourceLoader.exists("res://assets/icons/network.svg") else null
    },
    "connectivity_maps": {
        "text": "Connectivity Maps",
        "icon": preload("res://assets/icons/connections.svg") if ResourceLoader.exists("res://assets/icons/connections.svg") else null
    },
    "time_series": {
        "text": "Time Series",
        "icon": preload("res://assets/icons/chart.svg") if ResourceLoader.exists("res://assets/icons/chart.svg") else null
    }
}
