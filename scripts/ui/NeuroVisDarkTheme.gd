...
static func create_theme() -> Theme:
    ...
    # Fonts
    var font_regular = preload("res://assets/fonts/Inter-Regular.ttf") if ResourceLoader.exists("res://assets/fonts/Inter-Regular.ttf") else null
    var font_bold = preload("res://assets/fonts/Inter-Bold.ttf") if ResourceLoader.exists("res://assets/fonts/Inter-Bold.ttf") else null
    var font_mono = preload("res://assets/fonts/JetBrainsMono-Regular.ttf") if ResourceLoader.exists("res://assets/fonts/JetBrainsMono-Regular.ttf") else null
