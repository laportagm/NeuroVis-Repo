...
func _exit_tree() -> void:
	...
	if selection_manager:
		# Disconnect signals
		if (
		selection_manager.has_signal("structure_selected")
		and selection_manager.structure_selected.is_connected(_on_manager_structure_selected)
		):
			selection_manager.structure_selected.disconnect(_on_manager_structure_selected)
			if (
			selection_manager.has_signal("structure_deselected")
			and selection_manager.structure_deselected.is_connected(
			_on_manager_structure_deselected
			)
			):
