...
func _animate_selection_pulse(mesh: MeshInstance3D) -> void:
    ...
    if material and material is StandardMaterial3D and material.emission_enabled:
        ...
        emission_tween.tween_method(func(energy): _set_material_emission(material, energy), original_energy, original_energy * 2.0, 0.1)
        emission_tween.tween_method(func(energy): _set_material_emission(material, energy), original_energy * 2.0, original_energy, 0.3)
