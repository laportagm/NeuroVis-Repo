...
enum InteractionMode {
	LEARNING,       # Student-focused, guided interactions
	EXPLORATION,    # Free exploration with assistance
	ASSESSMENT,     # Testing and evaluation mode
	CLINICAL,       # Professional clinical workflow
	ACCESSIBILITY   # Accessible interaction patterns
}
