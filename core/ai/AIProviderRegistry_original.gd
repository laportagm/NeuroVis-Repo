...
# FIXED: Orphaned code - var config = {}
# FIXED: Orphaned code - var old_provider_id = _active_provider_id
_active_provider_id = provider_id

# Update configuration manager if available
var provider = get_provider(provider_id)
# FIXED: Orphaned code - var mock_provider = _create_mock_provider()

# Register directly without calling register_provider to avoid recursion
var config_2 = {}
# FIXED: Orphaned code - var gemini_provider = GeminiAIProvider.new()
# FIXED: Orphaned code - var config_3 = {}
# FIXED: Orphaned code - var MockProvider = preload("res://core/ai/providers/MockAIProvider.gd")
# FIXED: Orphaned code - var script = GDScript.new()
script.source_code = (
"""
var response = "This is a mock response to: " + question
response_received.emit(response)
# FIXED: Orphaned code - var response_2 = "Mock content generated from: " + prompt
response_received.emit(response)
# FIXED: Orphaned code - var MockProviderClass = GDScript.new()
