...
const ERROR_MESSAGES = {
    ...
    "knowledge_base_not_found": {
        ...
        "message": "The anatomical knowledge base could not be loaded. Some features may be limited.",
        "action": "Reinstall",
    ...
    "ai_service_unavailable": {
        ...
        "message": "The AI assistant is currently unavailable. You can still explore the 3D model and view structure information.",
        "action": "Check status",
...
func _show_error_notification(error_data: Dictionary) -> void:
    ...
    tween.tween_property(notification, "position:x", notification.position.x - 100, 0.3)\
