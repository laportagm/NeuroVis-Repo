...
func _add_outline_effect(
	_mesh: MeshInstance3D, _color: Color, _thickness: float = OUTLINE_THICKNESS
	) -> void:
...
func _animate_material_transition(
	mesh: MeshInstance3D, target_material: Material, _duration: float
	) -> void:
