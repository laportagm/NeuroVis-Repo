...
func focus_on_position(position: Vector3, transition_time: float = 0.0) -> bool:
	...
	if transition_time <= 0.0:
		...
		# Animated transition
		_animate_property(_key_light, "position", _key_light.position, new_key_position, transition_time)
		_animate_property(_fill_light, "position", _fill_light.position, new_fill_position, transition_time)
		_animate_property(_rim_light, "position", _rim_light.position, new_rim_position, transition_time)
