...
# FIXME: Orphaned code - current_structure = analysis_manager.analyze_structure(structure_data["id"])
# Fallback to basic data
# FIXME: Orphaned code - current_structure = structure_data
...
# FIXME: Orphaned code - _info_label.text = display_text
