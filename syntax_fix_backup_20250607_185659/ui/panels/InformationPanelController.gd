...
# FIXME: Orphaned code - title_label = Label.new()
# FIXME: Orphaned code - title_label.text = "Structure Information"
# FIXME: Orphaned code - title_label.size_flags_horizontal = Control.SIZE_EXPAND_FILL
header.add_child(title_label)

# FIXME: Orphaned code - close_button = Button.new()
# FIXME: Orphaned code - close_button.text = "×"
# FIXME: Orphaned code - close_button.custom_minimum_size = Vector2(30, 30)
# FIXME: Orphaned code - close_button.flat = true
...
# FIXME: Orphaned code - desc_header.text = "Description"
content.add_child(desc_header)

# FIXME: Orphaned code - description_label = RichTextLabel.new()
# FIXME: Orphaned code - description_label.custom_minimum_size = Vector2(0, 100)
# FIXME: Orphaned code - description_label.fit_content = true
# FIXME: Orphaned code - description_label.bbcode_enabled = true
content.add_child(description_label)

# Functions
var func_header = Label.new()
# FIXME: Orphaned code - func_header.text = "Functions"
content.add_child(func_header)

# FIXME: Orphaned code - functions_container = VBoxContainer.new()
content.add_child(functions_container)


var style = StyleBoxFlat.new()
# FIXME: Orphaned code - style.bg_color = Color(0.1, 0.1, 0.15, 0.9)
# FIXME: Orphaned code - style.border_color = Color(0.3, 0.3, 0.4, 0.7)
# FIXME: Orphaned code - style.border_width_top = 2
# FIXME: Orphaned code - style.border_width_bottom = 2
# FIXME: Orphaned code - style.border_width_left = 2
# FIXME: Orphaned code - style.border_width_right = 2
# FIXME: Orphaned code - style.corner_radius_top_left = 10
# FIXME: Orphaned code - style.corner_radius_top_right = 10
# FIXME: Orphaned code - style.corner_radius_bottom_left = 10
# FIXME: Orphaned code - style.corner_radius_bottom_right = 10
add_theme_stylebox_override("panel", style)

# Title styling
var display_name = structure_data.get("displayName", "Unknown Structure")
# FIXME: Orphaned code - title_label.text = display_name

# Update description
var description = structure_data.get("shortDescription", "No description available.")
# FIXME: Orphaned code - description_label.text = "[color=#E0E0E0]%s[/color]" % description
