...
# FIXME: Orphaned code - label.text = display_name
# FIXME: Orphaned code - label.font_size = DEFAULT_FONT_SIZE
# FIXME: Orphaned code - label.modulate = Color(1.0, 1.0, 0.3)  # Yellow text
# FIXME: Orphaned code - label.outline_size = 1
# FIXME: Orphaned code - label.outline_modulate = Color(0, 0, 0, 0.8)  # Black outline
# FIXME: Orphaned code - label.no_depth_test = true  # Ensure always visible
# FIXME: Orphaned code - label.billboard = BaseMaterial3D.BILLBOARD_ENABLED  # Always face camera
...
# FIXME: Orphaned code - final_position.x += randf_range(-RANDOM_OFFSET_RANGE, RANDOM_OFFSET_RANGE)
# FIXME: Orphaned code - final_position.z += randf_range(-RANDOM_OFFSET_RANGE, RANDOM_OFFSET_RANGE)
# FIXME: Orphaned code - label.position = final_position

# Add to scene and track in dictionary
add_child(label)
# FIXME: Orphaned code - structure_labels[structure_id] = label

# Initially set visibility based on current state
# FIXME: Orphaned code - label.visible = labels_visible
...
# FIXME: Orphaned code - label_count = _process_node_for_labels(root_node, label_count)
