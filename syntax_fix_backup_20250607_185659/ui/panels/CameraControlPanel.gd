...
var label = Label.new()
# FIXME: Orphaned code - label.text = "Movement"
section.add_child(label)

var grid = GridContainer.new()
# FIXME: Orphaned code - grid.columns = 3
...
# FIXME: Orphaned code - button.text = directions[i]
button.pressed.connect(_on_movement_button_pressed.bind(vectors[i]))
# FIXME: Orphaned code - _movement_buttons[directions[i]] = button
grid.add_child(button)

section.add_child(grid)
var section_2 = VBoxContainer.new()
var label_2 = Label.new()
# FIXME: Orphaned code - label.text = "Rotation"
section.add_child(label)

# Pitch slider
var pitch_container = HBoxContainer.new()
var pitch_label = Label.new()
# FIXME: Orphaned code - pitch_label.text = "Pitch:"
var pitch_slider = HSlider.new()
# FIXME: Orphaned code - pitch_slider.min_value = -90.0
# FIXME: Orphaned code - pitch_slider.max_value = 90.0
# FIXME: Orphaned code - pitch_slider.value = 0.0
pitch_slider.value_changed.connect(_on_pitch_changed)
# FIXME: Orphaned code - _rotation_sliders["pitch"] = pitch_slider
...
# FIXME: Orphaned code - yaw_label.text = "Yaw:"
var yaw_slider = HSlider.new()
# FIXME: Orphaned code - yaw_slider.min_value = -180.0
# FIXME: Orphaned code - yaw_slider.max_value = 180.0
# FIXME: Orphaned code - yaw_slider.value = 0.0
yaw_slider.value_changed.connect(_on_yaw_changed)
# FIXME: Orphaned code - _rotation_sliders["yaw"] = yaw_slider
...
# FIXME: Orphaned code - label.text = "Zoom"
section.add_child(label)

var container = HBoxContainer.new()
var zoom_in = Button.new()
# FIXME: Orphaned code - zoom_in.text = "Zoom In"
zoom_in.pressed.connect(_on_zoom_in_pressed)

var zoom_out = Button.new()
# FIXME: Orphaned code - zoom_out.text = "Zoom Out"
zoom_out.pressed.connect(_on_zoom_out_pressed)

var zoom_reset = Button.new()
# FIXME: Orphaned code - zoom_reset.text = "Reset"
zoom_reset.pressed.connect(_on_zoom_reset_pressed)

# FIXME: Orphaned code - _zoom_controls["in"] = zoom_in
# FIXME: Orphaned code - _zoom_controls["out"] = zoom_out
# FIXME: Orphaned code - _zoom_controls["reset"] = zoom_reset
