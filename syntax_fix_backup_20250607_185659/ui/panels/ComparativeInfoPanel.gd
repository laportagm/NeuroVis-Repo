...
# FIXME: Orphaned code - relationship_label.text = "Anatomical Relationships:"
...
# FIXME: Orphaned code - card.custom_minimum_size = Vector2(0, STRUCTURE_CARD_HEIGHT)
...
# FIXME: Orphaned code - state_indicator.custom_minimum_size = Vector2(8, 30)
# FIXME: Orphaned code - state_indicator.name = "StateIndicator"
header.add_child(state_indicator)

var name_label = Label.new()
# FIXME: Orphaned code - name_label.name = "NameLabel"
name_label.add_theme_font_size_override("font_size", 18)
header.add_child(name_label)

var spacer = Control.new()
# FIXME: Orphaned code - spacer.size_flags_horizontal = Control.SIZE_EXPAND_FILL
header.add_child(spacer)

var focus_button = Button.new()
# FIXME: Orphaned code - focus_button.text = "Focus"
# FIXME: Orphaned code - focus_button.name = "FocusButton"
# FIXME: Orphaned code - focus_button.custom_minimum_size = Vector2(60, 0)
...
# FIXME: Orphaned code - facts_label.name = "FactsLabel"
# FIXME: Orphaned code - facts_label.autowrap_mode = TextServer.AUTOWRAP_WORD_SMART
vbox.add_child(facts_label)

# Functions
var functions_label = Label.new()
# FIXME: Orphaned code - functions_label.name = "FunctionsLabel"
# FIXME: Orphaned code - functions_label.autowrap_mode = TextServer.AUTOWRAP_WORD_SMART
vbox.add_child(functions_label)

# Clinical relevance (abbreviated for space)
var clinical_label = Label.new()
# FIXME: Orphaned code - clinical_label.name = "ClinicalLabel"
# FIXME: Orphaned code - clinical_label.autowrap_mode = TextServer.AUTOWRAP_WORD_SMART
...
# FIXME: Orphaned code - panel_style.bg_color = colors["surface"]
# FIXME: Orphaned code - panel_style.border_color = colors["primary"]
...
# FIXME: Orphaned code - card_style.bg_color = colors["surface_variant"]
...
# FIXME: Orphaned code - structure_data = _knowledge_service.get_structure(normalized_name)
...
# FIXME: Orphaned code - rel_label.text = "• " + rel
# FIXME: Orphaned code - rel_label.autowrap_mode = TextServer.AUTOWRAP_WORD_SMART
relationship_container.add_child(rel_label)
var no_rel_label = Label.new()
# FIXME: Orphaned code - no_rel_label.text = "• No direct relationships found"
# FIXME: Orphaned code - no_rel_label.modulate.a = 0.6
