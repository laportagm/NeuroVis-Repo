...
# FIXME: Orphaned code - title_label.name = "TitleLabel"
# FIXME: Orphaned code - title_label.text = "NeuroVis"
...
# FIXME: Orphaned code - spacer.name = "HeaderSpacer"
...
# FIXME: Orphaned code - toggle_button.name = "ToggleButton"
# FIXME: Orphaned code - toggle_button.text = "≡"
# FIXME: Orphaned code - toggle_button.flat = true
toggle_button.add_theme_font_size_override("font_size", 20)
toggle_button.pressed.connect(_on_toggle_button_pressed)
_header_container.add_child(toggle_button)

# Sections container
# FIXME: Orphaned code - _sections_container = VBoxContainer.new()
# FIXME: Orphaned code - _sections_container.name = "SectionsContainer"
_sections_container.add_theme_constant_override("separation", SECTION_SPACING)
# FIXME: Orphaned code - _sections_container.size_flags_vertical = Control.SIZE_EXPAND_FILL
...
# FIXME: Orphaned code - panel_style.bg_color = background_color
# FIXME: Orphaned code - panel_style.border_width_right = 1
# FIXME: Orphaned code - panel_style.border_color = Color(0.2, 0.2, 0.2, 0.7)
