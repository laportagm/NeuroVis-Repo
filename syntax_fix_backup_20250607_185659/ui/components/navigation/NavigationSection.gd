...
# Header
# FIXME: Orphaned code - _header_container = PanelContainer.new()
# FIXME: Orphaned code - _header_container.name = "HeaderContainer"
# FIXME: Orphaned code - _header_container.custom_minimum_size.y = _header_height
...
# Icon
# FIXME: Orphaned code - _icon_rect = TextureRect.new()
# FIXME: Orphaned code - _icon_rect.name = "IconRect"
# FIXME: Orphaned code - _icon_rect.custom_minimum_size = Vector2(20, 20)
# FIXME: Orphaned code - _icon_rect.stretch_mode = TextureRect.STRETCH_KEEP_ASPECT_CENTERED
...
# FIXME: Orphaned code - icon_rect.custom_minimum_size = Vector2(16, 16)
var label = Label.new()
# FIXME: Orphaned code - label.text = item_data.text
# FIXME: Orphaned code - label.visible = show_item_labels
...
# FIXME: Orphaned code - _item_nodes[item_id] = item
...
# FIXME: Orphaned code - panel_style.bg_color = Color(0, 0, 0, 0)
add_theme_stylebox_override("panel", panel_style)

# Header style
var header_style = StyleBoxFlat.new()
# FIXME: Orphaned code - header_style.bg_color = bg_color
# FIXME: Orphaned code - header_style.corner_radius_top_left = 6
# FIXME: Orphaned code - header_style.corner_radius_top_right = 6
# FIXME: Orphaned code - header_style.corner_radius_bottom_left = expanded ? 0 : 6
# FIXME: Orphaned code - header_style.corner_radius_bottom_right = expanded ? 0 : 6
# FIXME: Orphaned code - header_style.content_margin_left = 8
# FIXME: Orphaned code - header_style.content_margin_right = 8
# FIXME: Orphaned code - header_style.content_margin_top = 8
# FIXME: Orphaned code - header_style.content_margin_bottom = 8
...
# FIXME: Orphaned code - _icon_rect.modulate = secondary_color

# Make header container interactive
# FIXME: Orphaned code - _header_container.mouse_default_cursor_shape = Control.CURSOR_POINTING_HAND
