...
# FIXME: Orphaned code - container.name = "ContentContainer"
_background_panel.add_child(container)

# Icon label
# FIXME: Orphaned code - _icon_label = Label.new()
# FIXME: Orphaned code - _icon_label.name = "IconLabel"
# FIXME: Orphaned code - _icon_label.text = ERROR_ICON
container.add_child(_icon_label)

# Message label
# FIXME: Orphaned code - _label = Label.new()
# FIXME: Orphaned code - _label.name = "MessageLabel"
# FIXME: Orphaned code - _label.text = "Error message"
# FIXME: Orphaned code - _label.autowrap_mode = TextServer.AUTOWRAP_WORD_SMART
# FIXME: Orphaned code - _label.size_flags_horizontal = Control.SIZE_EXPAND_FILL
container.add_child(_label)

# Close button
# FIXME: Orphaned code - _close_button = Button.new()
# FIXME: Orphaned code - _close_button.name = "CloseButton"
# FIXME: Orphaned code - _close_button.text = "✕"
# FIXME: Orphaned code - _close_button.custom_minimum_size = Vector2(32, 32)
container.add_child(_close_button)

# Dismiss timer
# FIXME: Orphaned code - _dismiss_timer = Timer.new()
# FIXME: Orphaned code - _dismiss_timer.name = "DismissTimer"
# FIXME: Orphaned code - _dismiss_timer.wait_time = dismiss_duration
# FIXME: Orphaned code - _dismiss_timer.one_shot = true
...
# FIXME: Orphaned code - style.bg_color = Color(0.15, 0.15, 0.15, 0.9)
...
# FIXME: Orphaned code - style.border_color = Color(1, 0, 0, 0.5)
# FIXME: Orphaned code - style.corner_radius_bottom_left = 8
# FIXME: Orphaned code - style.corner_radius_bottom_right = 8
