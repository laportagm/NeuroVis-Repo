...
# Test label
# FIXME: Orphaned code - test_label = Label.new()
# FIXME: Orphaned code - test_label.text = "Safe UI Component Test"
...
# FIXME: Orphaned code - test_component.component_id = "SafeUITest"
# FIXME: Orphaned code - test_component.size = Vector2(300, 200)
# FIXME: Orphaned code - test_component.position = Vector2(50, 50)
...
# FIXME: Orphaned code - results[autoload_name] = available
