...
# FIXME: Orphaned code - content_style.bg_color = UIThemeManager.get_color("surface_bg")
# FIXME: Orphaned code - content_style.corner_radius_top_left = 4
# FIXME: Orphaned code - content_style.corner_radius_top_right = 4
# FIXME: Orphaned code - content_style.corner_radius_bottom_left = 4
# FIXME: Orphaned code - content_style.corner_radius_bottom_right = 4
# FIXME: Orphaned code - content_style.content_margin_left = UIThemeManager.get_spacing("md")
# FIXME: Orphaned code - content_style.content_margin_right = UIThemeManager.get_spacing("md")
# FIXME: Orphaned code - content_style.content_margin_top = UIThemeManager.get_spacing("sm")
# FIXME: Orphaned code - content_style.content_margin_bottom = UIThemeManager.get_spacing("sm")
...
# FIXME: Orphaned code - highlighted_content = highlighted_content.replace(
# FIXME: Orphaned code - match_text, "[bgcolor=yellow]" + match_text + "[/bgcolor]"
)

# FIXME: Orphaned code - matches = results.size()
# FIXME: Orphaned code - content_label.text = highlighted_content

var title_text = section_title.to_upper()

var arrow = "▼" if is_expanded else "▶"
# FIXME: Orphaned code - header_button.text = arrow + " " + title_text
# FIXME: Orphaned code - header_button.disabled = false
# FIXME: Orphaned code - header_button.text = title_text
# FIXME: Orphaned code - header_button.disabled = true
...
# FIXME: Orphaned code - tween.tween_callback(func(): content_container.visible = false)
...
# FIXME: Orphaned code - content_type = "rich"

var formatted_2 = description
var first_sentence = formatted.split(".")[0] + "."
# FIXME: Orphaned code - formatted = "[b]" + first_sentence + "[/b]" + formatted.substr(first_sentence.length())
set_content(formatted)


var functions = data.get("functions", [])
# FIXME: Orphaned code - content_type = "list"
...
# FIXME: Orphaned code - formatted = regex.sub(formatted, "[i]" + keyword + "[/i]", true)
set_content(formatted)
