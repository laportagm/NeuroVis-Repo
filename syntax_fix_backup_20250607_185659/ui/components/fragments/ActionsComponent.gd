...
# FIXME: Orphaned code - style.content_margin_top = UIThemeManager.get_spacing("sm")
...
# FIXME: Orphaned code - button.text = text
...
# FIXME: Orphaned code - separator.custom_minimum_size = Vector2(2, button_size.y)
# FIXME: Orphaned code - separator.name = "Separator_" + str(separator_count)
# FIXME: Orphaned code - separator_count += 1
add_child(separator)
...
# FIXME: Orphaned code - group_container.name = "Group_" + group_name
group_container.add_theme_constant_override("separation", UIThemeManager.get_spacing("xs"))
add_child(group_container)
# FIXME: Orphaned code - button_groups[group_name] = group_container
...
# FIXME: Orphaned code - action_data["timestamp"] = Time.get_unix_time_from_system()
