...
# Chat area
# FIXME: Orphaned code - chat_container = _create_chat_area()
main_container.add_child(chat_container)

# Suggestions
# FIXME: Orphaned code - suggestions_container = _create_suggestions_area()
...
# FIXME: Orphaned code - source_panel = _create_source_panel()
...
# Title
var title = Label.new()
# FIXME: Orphaned code - title.text = "AI Assistant"
...
# FIXME: Orphaned code - mode_label.text = "Mode:"
header.add_child(mode_label)

# FIXME: Orphaned code - mode_selector = OptionButton.new()
...
# FIXME: Orphaned code - mode_selector.selected = EducationalMode.STUDENT
mode_selector.item_selected.connect(_on_mode_changed)
header.add_child(mode_selector)

# Settings button
var settings_btn = Button.new()
# FIXME: Orphaned code - settings_btn.text = "⚙"
# FIXME: Orphaned code - settings_btn.tooltip_text = "AI Settings"
# FIXME: Orphaned code - settings_btn.custom_minimum_size = Vector2(32, 32)
settings_btn.pressed.connect(_on_settings_pressed)
header.add_child(settings_btn)

var scroll = ScrollContainer.new()
# FIXME: Orphaned code - scroll.size_flags_vertical = Control.SIZE_EXPAND_FILL
# FIXME: Orphaned code - scroll.custom_minimum_size.y = 400

# FIXME: Orphaned code - chat_messages = VBoxContainer.new()
# FIXME: Orphaned code - chat_messages.size_flags_horizontal = Control.SIZE_EXPAND_FILL
...
# Suggestions label
var label = Label.new()
# FIXME: Orphaned code - label.text = "Suggested questions:"
...
# Input field
# FIXME: Orphaned code - input_field = LineEdit.new()
# FIXME: Orphaned code - input_field.placeholder_text = "Ask about the selected brain structure..."
# FIXME: Orphaned code - input_field.size_flags_horizontal = Control.SIZE_EXPAND_FILL
...
# FIXME: Orphaned code - panel.custom_minimum_size.y = 100
# FIXME: Orphaned code - panel.visible = false

var style = StyleBoxFlat.new()
# FIXME: Orphaned code - style.bg_color = DesignSystem.get_color("surface")
# FIXME: Orphaned code - style.bg_color.a = 0.95
# FIXME: Orphaned code - style.corner_radius_top_left = 8
# FIXME: Orphaned code - style.corner_radius_top_right = 8
...
# FIXME: Orphaned code - title.text = "Sources"
...
# FIXME: Orphaned code - close_btn.text = "✕"
# FIXME: Orphaned code - close_btn.pressed.connect(func(): panel.visible = false)
...
# FIXME: Orphaned code - is_processing = false
# FIXME: Orphaned code - send_button.disabled = false
...
var btn = Button.new()
# FIXME: Orphaned code - btn.text = suggestion
...
# FIXME: Orphaned code - message.text = text
...
# FIXME: Orphaned code - message.autowrap_mode = TextServer.AUTOWRAP_WORD_SMART
chat_messages.add_child(message)
_scroll_to_bottom()
...
# FIXME: Orphaned code - bubble.size_flags_horizontal = Control.SIZE_SHRINK_CENTER
# FIXME: Orphaned code - bubble.custom_minimum_size.x = 100

var style_2 = StyleBoxFlat.new()
var label_2 = RichTextLabel.new()
# FIXME: Orphaned code - label.bbcode_enabled = true
# FIXME: Orphaned code - label.fit_content = true
# FIXME: Orphaned code - label.text = text
...
tween.set_loops()
# FIXME: Orphaned code - tween.tween_callback(func(): label.text = ".").set_delay(0.3)
# FIXME: Orphaned code - tween.tween_callback(func(): label.text = "..").set_delay(0.3)
# FIXME: Orphaned code - tween.tween_callback(func(): label.text = "...").set_delay(0.3)

var dialog = AcceptDialog.new()
# FIXME: Orphaned code - dialog.title = "AI Assistant Settings"
# FIXME: Orphaned code - dialog.dialog_hide_on_ok = true
...
# FIXME: Orphaned code - sources_check.text = "Show sources"
# FIXME: Orphaned code - sources_check.button_pressed = show_sources
# FIXME: Orphaned code - sources_check.toggled.connect(func(pressed): show_sources = pressed)
content.add_child(sources_check)

# Auto-suggest toggle
var suggest_check = CheckBox.new()
# FIXME: Orphaned code - suggest_check.text = "Show question suggestions"
# FIXME: Orphaned code - suggest_check.button_pressed = auto_suggest
