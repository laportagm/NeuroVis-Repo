...
# FIXME: Orphaned code - icon_label.custom_minimum_size.x = 32
title_bar.add_child(icon_label)

var title_label = UIComponentFactory.create_label("NeuroBot Assistant", "heading")
# FIXME: Orphaned code - title_label.size_flags_horizontal = Control.SIZE_EXPAND_FILL
...
# FIXME: Orphaned code - close_btn.tooltip_text = "Close AI Assistant"
close_btn.pressed.connect(_on_close_pressed)
title_bar.add_child(close_btn)


var provider_label = UIComponentFactory.create_label("AI Provider:", "caption")
# FIXME: Orphaned code - provider_label.custom_minimum_size.x = 100
model_selector_container.add_child(provider_label)

# Provider dropdown
# FIXME: Orphaned code - provider_selector = OptionButton.new()
# FIXME: Orphaned code - provider_selector.size_flags_horizontal = Control.SIZE_EXPAND_FILL

# Add provider options
var providers = ai_service.get_available_providers()
var style = UIThemeManager.create_enhanced_glass_style(0.8)
# FIXME: Orphaned code - style.bg_color = UIThemeManager.get_color("button_secondary")
...
# FIXME: Orphaned code - style.content_margin_left = 12
# FIXME: Orphaned code - style.content_margin_right = 12
# FIXME: Orphaned code - style.content_margin_top = 6
# FIXME: Orphaned code - style.content_margin_bottom = 6
...
# FIXME: Orphaned code - btn.tooltip_text = question_data.tooltip
...
# FIXME: Orphaned code - question_input = UIComponentFactory.create_text_input("Ask about brain anatomy...")
# FIXME: Orphaned code - question_input.size_flags_horizontal = Control.SIZE_EXPAND_FILL
# FIXME: Orphaned code - question_input.custom_minimum_size.y = 40
question_input.text_submitted.connect(_on_question_submitted)
input_row.add_child(question_input)

# Send button
# FIXME: Orphaned code - send_button = UIComponentFactory.create_button(
...
# FIXME: Orphaned code - dialog.title = "Gemini API Key Setup"
# FIXME: Orphaned code - dialog.dialog_text = "Enter your Google Gemini API key:"
# FIXME: Orphaned code - dialog.min_size = Vector2(400, 200)
...
var label = Label.new()
# FIXME: Orphaned code - label.text = "You can get a free API key from https://ai.google.dev/"
vbox.add_child(label)

var input = LineEdit.new()
# FIXME: Orphaned code - input.name = "APIKeyInput"
# FIXME: Orphaned code - input.placeholder_text = "Enter your API key here"
# FIXME: Orphaned code - input.secret = true
# FIXME: Orphaned code - input.custom_minimum_size.y = 40
