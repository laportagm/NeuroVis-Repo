...
# FIXME: Orphaned code - _current_session = {
"id": session_id,
"mode": mode,
"options": options,
...
var session_type = ""
0:  # Exploration
# FIXME: Orphaned code - session_type = "exploration"
# No specific setup needed

1:  # Guided
# FIXME: Orphaned code - session_type = "guided"
var end_time = Time.get_unix_time_from_system()
var duration = end_time - _current_session.start_time

# Update session data
# FIXME: Orphaned code - _current_session.end_time = end_time
# FIXME: Orphaned code - _current_session.duration = duration
...
# FIXME: Orphaned code - recommendation = {
