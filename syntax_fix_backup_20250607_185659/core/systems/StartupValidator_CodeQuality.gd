...
# FIXME: Orphaned code - _is_validating = false
...
# FIXME: Orphaned code - ValidationResult.PASS if passed == total else ValidationResult.FAIL
)
# FIXME: Orphaned code - _validation_results[ValidationCategory.AUTOLOADS] = {
"result": result,
"passed": passed,
"total": total,
...
# FIXME: Orphaned code - _validation_results[ValidationCategory.RESOURCES] = {
"result": result,
"passed": passed,
"total": total,
