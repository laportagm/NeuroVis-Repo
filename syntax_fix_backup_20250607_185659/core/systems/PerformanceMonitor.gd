...
# FIXME: Orphaned code - current_metrics[MetricType.MEMORY_USAGE] = static_memory

# Rendering metrics
# FIXME: Orphaned code - current_metrics[MetricType.DRAW_CALLS] = Performance.get_monitor(
Performance.RENDER_TOTAL_DRAW_CALLS_IN_FRAME
)
# FIXME: Orphaned code - current_metrics[MetricType.VERTEX_COUNT] = Performance.get_monitor(
Performance.RENDER_TOTAL_PRIMITIVES_IN_FRAME
)

# Physics and script time
# FIXME: Orphaned code - current_metrics[MetricType.PHYSICS_TIME] = Performance.get_monitor(
...
# FIXME: Orphaned code - panel_style.bg_color = Color(0, 0, 0, 0.7)
# FIXME: Orphaned code - panel_style.corner_radius_top_left = 8
# FIXME: Orphaned code - panel_style.corner_radius_top_right = 8
# FIXME: Orphaned code - panel_style.corner_radius_bottom_left = 8
# FIXME: Orphaned code - panel_style.corner_radius_bottom_right = 8
debug_panel.add_theme_stylebox_override("panel", panel_style)

debug_overlay.add_child(debug_panel)

# Metrics text
# FIXME: Orphaned code - metrics_label = RichTextLabel.new()
# FIXME: Orphaned code - metrics_label.bbcode_enabled = true
# FIXME: Orphaned code - metrics_label.fit_content = true
...
# Toggle visibility
# FIXME: Orphaned code - debug_overlay.visible = show_overlay
