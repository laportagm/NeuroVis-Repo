...
# FIXME: Orphaned code - info_label.text = "Select a test to run from the toolbar above"
...
# FIXME: Orphaned code - test_header.text = "Running test: " + test_name
...
# FIXME: Orphaned code - debug_visualizer.name = "DebugVisualizer"
# FIXME: Orphaned code - debug_visualizer.visualizations_enabled = debug_visualizations_enabled
# FIXME: Orphaned code - debug_visualizer.show_raycasts = show_raycasts
# FIXME: Orphaned code - debug_visualizer.show_collision_shapes = show_collision_shapes
# FIXME: Orphaned code - debug_visualizer.show_model_labels = show_model_labels
...
# FIXME: Orphaned code - message_label.text = formatted_message
var scroll_container = debug_messages.get_parent().get_parent()
# FIXME: Orphaned code - scroll_container.scroll_vertical = scroll_container.get_v_scroll_bar().max_value
...
# FIXME: Orphaned code - cleanup_timer.wait_time = 5.0  # Allow up to 5 seconds for test to complete
# FIXME: Orphaned code - cleanup_timer.one_shot = true
