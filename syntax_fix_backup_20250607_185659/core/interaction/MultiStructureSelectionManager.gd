...
# FIXME: Orphaned code - state_material.albedo_color = colors["default"]
# FIXME: Orphaned code - state_material.emission_enabled = true
# FIXME: Orphaned code - state_material.emission = colors["default"]
# FIXME: Orphaned code - state_material.emission_energy_multiplier = colors["emission"]
# FIXME: Orphaned code - state_material.rim_enabled = true
# FIXME: Orphaned code - state_material.rim = 1.0
# FIXME: Orphaned code - state_material.rim_tint = 0.8

# Apply with proper transparency
# FIXME: Orphaned code - state_material.transparency = BaseMaterial3D.TRANSPARENCY_ALPHA
# FIXME: Orphaned code - state_material.albedo_color.a = 0.85
...
# FIXME: Orphaned code - material.albedo_color = colors["default"]
# FIXME: Orphaned code - material.emission_enabled = true
# FIXME: Orphaned code - material.emission = colors["default"]
# FIXME: Orphaned code - material.emission_energy_multiplier = colors["emission"]
# FIXME: Orphaned code - material.transparency = BaseMaterial3D.TRANSPARENCY_ALPHA
# FIXME: Orphaned code - material.albedo_color.a = 0.85
