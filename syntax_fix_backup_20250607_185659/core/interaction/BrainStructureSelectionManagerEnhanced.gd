...
# FIXME: Orphaned code - last_selection_confidence = hit_data["confidence"]

# Apply highlighting
highlight_mesh(hit_mesh)
# FIXME: Orphaned code - current_selected_mesh = hit_mesh
...
# FIXME: Orphaned code - ray_params.collision_mask = 0xFFFFFFFF
# FIXME: Orphaned code - ray_params.collide_with_areas = true
# FIXME: Orphaned code - ray_params.hit_from_inside = true  # Important for overlapping geometry
...
# FIXME: Orphaned code - screen_min = screen_min.min(screen_pos)
# FIXME: Orphaned code - screen_max = screen_max.max(screen_pos)

var screen_size = screen_max - screen_min
var viewport_size = get_viewport().get_visible_rect().size
var size_percentage = (screen_size.length() / viewport_size.length()) * 100.0

# FIXME: Orphaned code - structure_sizes[mesh] = size_percentage
...
# FIXME: Orphaned code - hover_material.albedo_color = hover_color.lightened(0.3)
# FIXME: Orphaned code - hover_material.emission_enabled = true
# FIXME: Orphaned code - hover_material.emission = hover_color
# FIXME: Orphaned code - hover_material.emission_energy_multiplier = 0.5
# FIXME: Orphaned code - hover_material.transparency = BaseMaterial3D.TRANSPARENCY_ALPHA
# FIXME: Orphaned code - hover_material.metallic = 0.2
# FIXME: Orphaned code - hover_material.roughness = 0.3
# FIXME: Orphaned code - hover_material.rim_enabled = true
# FIXME: Orphaned code - hover_material.rim_tint = 0.8
# FIXME: Orphaned code - hover_material.rim = 0.5

var surface_count = mesh.mesh.get_surface_count()
var highlight_material = StandardMaterial3D.new()
# FIXME: Orphaned code - highlight_material.albedo_color = highlight_color.lightened(0.2)
# FIXME: Orphaned code - highlight_material.emission_enabled = true
# FIXME: Orphaned code - highlight_material.emission = highlight_color
# FIXME: Orphaned code - highlight_material.emission_energy_multiplier = emission_energy
# FIXME: Orphaned code - highlight_material.metallic = 0.3
# FIXME: Orphaned code - highlight_material.roughness = 0.2
# FIXME: Orphaned code - highlight_material.rim_enabled = true
# FIXME: Orphaned code - highlight_material.rim_tint = 0.8
# FIXME: Orphaned code - highlight_material.rim = 0.5
# FIXME: Orphaned code - highlight_material.transparency = BaseMaterial3D.TRANSPARENCY_ALPHA
# FIXME: Orphaned code - highlight_material.albedo_color.a = 0.8
