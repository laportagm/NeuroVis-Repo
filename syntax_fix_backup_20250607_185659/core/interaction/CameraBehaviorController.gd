...
# FIXME: Orphaned code - pan_velocity = cam_transform.basis.x * pan_delta.x + cam_transform.basis.y * pan_delta.y

# FIXME: Orphaned code - last_mouse_pos = event.position
...
# FIXME: Orphaned code - zoom_velocity -= (event.factor - 1.0) * ZOOM_SPEED * 10.0


var needs_update = false

var pos = Vector3()
# FIXME: Orphaned code - pos.x = camera_distance * cos(camera_rotation.x) * sin(camera_rotation.y)
# FIXME: Orphaned code - pos.y = camera_distance * sin(camera_rotation.x)
# FIXME: Orphaned code - pos.z = camera_distance * cos(camera_rotation.x) * cos(camera_rotation.y)
