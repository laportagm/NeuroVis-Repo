...
# FIXME: Orphaned code - model_definitions = default_models
...
# FIXME: Orphaned code - model_instance.name = model_name
...
# FIXME: Orphaned code - collision_shape.shape = shape

var needs_default_material = true

# Check if any surface has a material
var default_material = StandardMaterial3D.new()
# FIXME: Orphaned code - default_material.albedo_color = Color(0.9, 0.9, 0.9, 1.0)
# FIXME: Orphaned code - default_material.metallic = 0.1
# FIXME: Orphaned code - default_material.roughness = 0.7
