...
# FIXME: Orphaned code - meshes_found += 1
...
# FIXME: Orphaned code - std_mat.transparency = BaseMaterial3D.TRANSPARENCY_DISABLED
# FIXME: Orphaned code - std_mat.cull_mode = BaseMaterial3D.CULL_BACK
