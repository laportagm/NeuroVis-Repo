...
# FIXME: Orphaned code - _active_provider_id = provider_id
...
# FIXME: Orphaned code - script.source_code = (
"""
...
# FIXME: Orphaned code - MockProviderClass.source_code = script.source_code
