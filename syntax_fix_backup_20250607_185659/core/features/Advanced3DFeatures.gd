...
# FIXME: Orphaned code - plane.mesh = PlaneMesh.new()
# FIXME: Orphaned code - plane.mesh.size = Vector2(10, 10)  # Large enough to cover brain
# FIXME: Orphaned code - plane.visible = false
# FIXME: Orphaned code - plane.name = _get_axis_name(axis) + "_slice_plane"
