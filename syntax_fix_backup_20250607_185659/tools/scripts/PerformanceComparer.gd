...
# FIXME: Orphaned code - comparison_report["metrics"] = {}
# FIXME: Orphaned code - comparison_report["summary"] = {}
...
var change_percent = (
# FIXME: Orphaned code - ((curr_value - prev_value) / prev_value) * 100.0 if prev_value != 0 else 0
)
...
# FIXME: Orphaned code - report_content += (
"| %s | %.4f | %.4f | %.1f%% | %s %s |\n"
% [
metric_name,
metric["previous"],
