...
# FIXME: Orphaned code - benchmark_results["data_kb_loading_avg_ms"] = kb_avg
...
# FIXME: Orphaned code - benchmark_results["data_json_parsing_avg_ms"] = json_avg
var model_paths = [
...
# FIXME: Orphaned code - total_load_time += load_time
var avg_load_time = float(total_load_time) / float(loaded_models) if loaded_models > 0 else 0
# FIXME: Orphaned code - benchmark_results["rendering_avg_model_load_ms"] = avg_load_time
# FIXME: Orphaned code - benchmark_results["rendering_total_models_loaded"] = loaded_models
...
# FIXME: Orphaned code - transform = transform.rotated(Vector3.UP, randf() * PI)
# FIXME: Orphaned code - transform = transform.translated(Vector3(randf(), randf(), randf()))
...
# FIXME: Orphaned code - benchmark_results["rendering_transform_calc_avg_ms"] = transform_avg
...
# FIXME: Orphaned code - benchmark_results["memory_allocation_ms"] = memory_alloc_time
# FIXME: Orphaned code - benchmark_results["memory_cleanup_ms"] = cleanup_time
# FIXME: Orphaned code - benchmark_results["memory_objects_created"] = array_count * array_size
...
# FIXME: Orphaned code - benchmark_results["system_file_ops_avg_ms"] = fs_avg
var string_start = Time.get_ticks_msec()
var string_ops = 50000
var test_strings = []

var test_str = "test_string_%d" % i
# FIXME: Orphaned code - test_str = test_str.to_upper()
# FIXME: Orphaned code - test_str = test_str.replace("_", "-")
...
# FIXME: Orphaned code - benchmark_results["system_string_ops_avg_ms"] = string_avg
