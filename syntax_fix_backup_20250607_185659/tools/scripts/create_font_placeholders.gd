...
# FIXME: Orphaned code - system_font.font_names = font_config.font_names
# FIXME: Orphaned code - system_font.font_weight = font_config.weight
# FIXME: Orphaned code - system_font.font_italic = font_config.italic
# FIXME: Orphaned code - system_font.antialiasing = TextServer.FONT_ANTIALIASING_GRAY
# FIXME: Orphaned code - system_font.hinting = TextServer.HINTING_LIGHT
# FIXME: Orphaned code - system_font.subpixel_positioning = TextServer.SUBPIXEL_POSITIONING_DISABLED
