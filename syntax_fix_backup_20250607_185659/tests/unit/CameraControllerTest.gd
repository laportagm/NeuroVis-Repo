...
var camera_controller = prepreprepreload("res://core/interaction/CameraBehaviorController.gd").new()
...
# FIXME: Orphaned code - key_event.keycode = KEY_A
# FIXME: Orphaned code - handled = camera_controller.handle_camera_input(key_event)
