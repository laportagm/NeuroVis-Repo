...
# FIXME: Orphaned code - did_hit_object = _test_raycast(upper_pos, "upper center")

var lower_pos = Vector2(center_screen_pos.x, center_screen_pos.y * 1.3)
# FIXME: Orphaned code - did_hit_object = _test_raycast(lower_pos, "lower center")

var left_pos = Vector2(center_screen_pos.x * 0.7, center_screen_pos.y)
# FIXME: Orphaned code - did_hit_object = _test_raycast(left_pos, "left center")

var right_pos = Vector2(center_screen_pos.x * 1.3, center_screen_pos.y)
# FIXME: Orphaned code - did_hit_object = _test_raycast(right_pos, "right center")
