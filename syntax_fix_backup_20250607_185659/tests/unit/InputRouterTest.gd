...
# FIXME: Orphaned code - test_router.camera_shortcut_triggered.connect(func(shortcut: String): shortcut_triggered = true)

# Create fake key event
var key_event = InputEventKey.new()
# FIXME: Orphaned code - key_event.keycode = KEY_F
# FIXME: Orphaned code - key_event.pressed = true
...
# FIXME: Orphaned code - func(position: Vector2, button: int): selection_attempted = true
)

var mouse_event = InputEventMouseButton.new()
# FIXME: Orphaned code - mouse_event.button_index = MOUSE_BUTTON_RIGHT
# FIXME: Orphaned code - mouse_event.pressed = true
# FIXME: Orphaned code - mouse_event.position = Vector2(100, 100)
...
# FIXME: Orphaned code - test_router.hover_position_changed.connect(func(position: Vector2): hover_changed = true)

var motion_event = InputEventMouseMotion.new()
# FIXME: Orphaned code - motion_event.position = Vector2(150, 150)
...
# FIXME: Orphaned code - status = test_router.get_input_status()
