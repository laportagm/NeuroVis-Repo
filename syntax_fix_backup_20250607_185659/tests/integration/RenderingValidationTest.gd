...
# FIXME: Orphaned code - progress_label.name = "ProgressLabel"
# FIXME: Orphaned code - progress_label.text = "Rendering Validation Tests"
# FIXME: Orphaned code - progress_label.horizontal_alignment = HORIZONTAL_ALIGNMENT_CENTER
# FIXME: Orphaned code - progress_label.vertical_alignment = VERTICAL_ALIGNMENT_TOP
progress_label.set_anchors_preset(Control.PRESET_TOP_WIDE)
# FIXME: Orphaned code - progress_label.position.y = 20
_test_ui.add_child(progress_label)

# Add progress bar
var progress_bar = ProgressBar.new()
# FIXME: Orphaned code - progress_bar.name = "ProgressBar"
progress_bar.set_anchors_preset(Control.PRESET_TOP_WIDE)
# FIXME: Orphaned code - progress_bar.position.y = 60
# FIXME: Orphaned code - progress_bar.size.y = 20
# FIXME: Orphaned code - progress_bar.min_value = 0
...
# FIXME: Orphaned code - _test_ui.visible = false

var progress_label_2 = _test_ui.get_node("ProgressLabel")
var progress_bar_2 = _test_ui.get_node("ProgressBar")

# FIXME: Orphaned code - progress_label.text = "Test " + str(_test_counter) + "/" + str(_total_tests) + ": " + _current_test
# FIXME: Orphaned code - progress_bar.value = ((_test_counter - 1) / float(_total_tests)) * 100

# Take baseline screenshot if needed
var test_results = _calculate_test_results()
# FIXME: Orphaned code - results.tests[_current_test] = test_results

var test_results_2 = {}

# Common metrics for all tests
# FIXME: Orphaned code - test_results["frame_count"] = _frame_times.size()

var total_time = 0.0
var current_memory = Performance.get_monitor(Performance.MEMORY_STATIC) + Performance.get_monitor(Performance.MEMORY_DYNAMIC)
# FIXME: Orphaned code - test_results["memory_usage"] = current_memory
...
# FIXME: Orphaned code - summary["performance_acceptable"] = summary.get("average_fps", 0) >= performance_threshold
# FIXME: Orphaned code - summary["memory_acceptable"] = summary.get("average_memory_impact", 0) <= memory_threshold
# FIXME: Orphaned code - summary["quality_acceptable"] = summary.get("average_visual_quality", 0) >= quality_threshold

# FIXME: Orphaned code - summary["overall_success"] = summary.performance_acceptable and summary.memory_acceptable and summary.quality_acceptable

# Store in results
# FIXME: Orphaned code - results["summary"] = summary
...
# FIXME: Orphaned code - view_timer.wait_time = TEST_DURATION / 4.0
