...
# FIXME: Orphaned code - mock_event.button_index = MOUSE_BUTTON_RIGHT
# FIXME: Orphaned code - mock_event.pressed = true
# FIXME: Orphaned code - mock_event.position = Vector2(400, 300) # Center of viewport
