...
# FIXME: Orphaned code - brain_model.name = "Half_Brain"
var internal_model = TestFramework.MockNode3D.new()
# FIXME: Orphaned code - internal_model.name = "Internal_Structures"
var brainstem_model = TestFramework.MockNode3D.new()
# FIXME: Orphaned code - brainstem_model.name = "Brainstem"
