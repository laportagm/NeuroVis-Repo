...
"Half_Brain":
	...
	"keywords":
		["cortex", "hemisphere", "lobes", "frontal", "parietal", "temporal", "occipital"]
		},
		"Internal_Structures":
			{
...
var chip_2 = Button.new()
	...
	# Apply chip styling
var accent_color = (
	category_data["color"] if category_id != "all" else UIThemeManager.ACCENT_BLUE
	)
...
var card = _create_enhanced_model_card(model_name, i)
	...
	card, i * 0.1, UIThemeManager.ANIM_DURATION_STANDARD, "slide_up"
	)
...
var card_2 = PanelContainer.new()
	...
	# Get model metadata
var metadata = model_metadata.get(
	model_name,
	{
	"category": "all",
	"difficulty": "beginner",
...
var icon_label = Label.new()
	...
	icon_label, UIThemeManager.FONT_SIZE_LARGE, category_data["color"]
	)
...
var difficulty_label = Label.new()
	...
	_get_difficulty_color(difficulty),
	"badge",
	true
	)
...
var desc_label = Label.new()
	...
	UIThemeManager.apply_modern_label(
	desc_label, UIThemeManager.FONT_SIZE_SMALL, UIThemeManager.TEXT_SECONDARY
	)
...
var status_color = (
	...
	UIThemeManager.apply_modern_label(
	status_label, UIThemeManager.FONT_SIZE_SMALL, status_color
	)
...
func _create_card_view_content(
	card: PanelContainer, model_name: String, metadata: Dictionary
	) -> void:
		"""Create card view layout"""
func _create_list_view_content(
	card: PanelContainer, model_name: String, metadata: Dictionary
	) -> void:
...
func _on_model_toggled(pressed: bool, model_name: String, status_label: Label) -> void:
	...
	status_label, "👁️ Visible" if pressed else "👁️‍🗨️ Hidden"
	)
...
func _on_view_mode_pressed() -> void:
	...
	"Switch to %s view" % ("list" if current_view_mode == "cards" else "card")
	)
