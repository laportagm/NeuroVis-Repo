...
# FIXME: Orphaned code - selection_manager = SelectionManagerScript.new()
# FIXME: Orphaned code - selection_manager.name = "BrainStructureSelectionManager"
...
# FIXME: Orphaned code - object_name_label.text = "Selected: " + selection["name"]

# Update AI context
var names = []
var notification = Label.new()
# FIXME: Orphaned code - notification.text = "Maximum 3 structures can be selected for comparison"
...
# FIXME: Orphaned code - notification.position.y = 100
# FIXME: Orphaned code - notification.horizontal_alignment = HORIZONTAL_ALIGNMENT_CENTER
