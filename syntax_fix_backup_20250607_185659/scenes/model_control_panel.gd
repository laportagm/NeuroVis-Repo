...
# FIXME: Orphaned code - style.bg_color = Color(0.1, 0.1, 0.15, 0.9)
# FIXME: Orphaned code - style.corner_radius_top_left = 12
# FIXME: Orphaned code - style.corner_radius_top_right = 12
# FIXME: Orphaned code - style.corner_radius_bottom_left = 12
# FIXME: Orphaned code - style.corner_radius_bottom_right = 12
# FIXME: Orphaned code - style.border_width_left = 1
# FIXME: Orphaned code - style.border_width_right = 1
# FIXME: Orphaned code - style.border_width_top = 1
# FIXME: Orphaned code - style.border_width_bottom = 1
# FIXME: Orphaned code - style.border_color = Color(1, 1, 1, 0.1)
# FIXME: Orphaned code - style.shadow_size = 16
# FIXME: Orphaned code - style.shadow_color = Color(0, 0, 0, 0.3)
# FIXME: Orphaned code - style.shadow_offset = Vector2(0, 4)
...
# FIXME: Orphaned code - model_cards[model_names[i]] = card
...
var title = Label.new()
# FIXME: Orphaned code - title.text = "Brain Models"
...
# FIXME: Orphaned code - subtitle.text = "Toggle layer visibility"
subtitle.add_theme_font_size_override("font_size", 12)
subtitle.add_theme_color_override("font_color", Color(1, 1, 1, 0.6))
# FIXME: Orphaned code - subtitle.horizontal_alignment = HORIZONTAL_ALIGNMENT_CENTER
container.add_child(subtitle)

# Add spacer
var spacer = Control.new()
# FIXME: Orphaned code - spacer.custom_minimum_size.y = 8
...
# FIXME: Orphaned code - card_style.bg_color = Color("#16213E").darkened(0.1)  # Surface light darkened
# FIXME: Orphaned code - card_style.corner_radius_top_left = 8
# FIXME: Orphaned code - card_style.corner_radius_top_right = 8
# FIXME: Orphaned code - card_style.corner_radius_bottom_left = 8
# FIXME: Orphaned code - card_style.corner_radius_bottom_right = 8
# FIXME: Orphaned code - card_style.content_margin_left = 12
# FIXME: Orphaned code - card_style.content_margin_right = 12
# FIXME: Orphaned code - card_style.content_margin_top = 12
# FIXME: Orphaned code - card_style.content_margin_bottom = 12
# FIXME: Orphaned code - card_style.border_width_left = 1
# FIXME: Orphaned code - card_style.border_width_right = 1
# FIXME: Orphaned code - card_style.border_width_top = 1
# FIXME: Orphaned code - card_style.border_width_bottom = 1
# FIXME: Orphaned code - card_style.border_color = Color(1, 1, 1, 0.05)
...
# FIXME: Orphaned code - info.size_flags_horizontal = Control.SIZE_EXPAND_FILL
info.add_theme_constant_override("separation", 2)
hbox.add_child(info)

var name_label = Label.new()
# FIXME: Orphaned code - name_label.text = model_name
name_label.add_theme_font_size_override("font_size", 16)
name_label.add_theme_color_override("font_color", Color("#FFFFFF"))  # White text
info.add_child(name_label)

var status = Label.new()
# FIXME: Orphaned code - status.text = "Visible"
...
# FIXME: Orphaned code - toggle.button_pressed = true
toggle.toggled.connect(_on_model_toggled.bind(model_name, status))

# Style the toggle
var toggle_style = StyleBoxFlat.new()
# FIXME: Orphaned code - toggle_style.bg_color = Color("#00D9FF")  # Primary cyan
# FIXME: Orphaned code - toggle_style.corner_radius_top_left = 12
# FIXME: Orphaned code - toggle_style.corner_radius_top_right = 12
# FIXME: Orphaned code - toggle_style.corner_radius_bottom_left = 12
# FIXME: Orphaned code - toggle_style.corner_radius_bottom_right = 12
