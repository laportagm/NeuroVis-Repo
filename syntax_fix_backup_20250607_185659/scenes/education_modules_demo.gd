...
# FIXME: Orphaned code - system_switcher_ui.get_node("WholeButton").disabled = not available_systems.has(BrainSystemSwitcher.BrainSystem.WHOLE_BRAIN)
# FIXME: Orphaned code - system_switcher_ui.get_node("HalfButton").disabled = not available_systems.has(BrainSystemSwitcher.BrainSystem.HALF_SECTIONAL)
# FIXME: Orphaned code - system_switcher_ui.get_node("InternalButton").disabled = not available_systems.has(BrainSystemSwitcher.BrainSystem.INTERNAL_STRUCTURES)
# FIXME: Orphaned code - system_switcher_ui.get_node("BrainstemButton").disabled = not available_systems.has(BrainSystemSwitcher.BrainSystem.BRAINSTEM_FOCUS)
...
# FIXME: Orphaned code - current_mode = mode
