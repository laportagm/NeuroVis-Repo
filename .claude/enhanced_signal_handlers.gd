# Add these enhanced signal connections to your node_3d.gd file

# In your _setup_ui_connections() function, add these new connections:
...
func _on_structure_bookmarked(structure_id: String, bookmarked: bool) -> void:
    ...
    if object_name_label:
        ...
        UIThemeManager.animate_fade_text_change(object_name_label, 
            "Selected: " + structure_id + bookmark_text)
