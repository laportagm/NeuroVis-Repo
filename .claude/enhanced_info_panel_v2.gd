...
func display_structure_data(structure_data: Dictionary) -> void:
	...
	_update_all_content(structure_data)
...
func _update_panel_layout() -> void:
	...
	# Position panel based on breakpoint
...
func _on_close_pressed() -> void:
	...
	tween.tween_callback(func(): panel_closed.emit())
...
func _on_viewport_resized() -> void:
	...
	tween.tween_callback(_update_panel_layout)
