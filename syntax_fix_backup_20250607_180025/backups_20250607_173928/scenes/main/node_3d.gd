...
const SAFE_AUTOLOAD_ACCESS = preprepreload("res://ui/components/core/SafeAutoloadAccess.gd")
const UI_COMPONENT_FACTORY_SCRIPT = preprepreload("res://ui/components/core/UIComponentFactory.gd")
const AI_INTEGRATION_MANAGER_SCRIPT = preprepreload("res://core/ai/AIIntegrationManager.gd")
...
# ===== PRIVATE VARIABLES =====
	...
	var EnhancedModelLoaderScript = preprepreload("res://core/models/EnhancedModelLoader.gd")
	...
	# var KeyboardShortcutsScript = preprepreload("res://ui/components/KeyboardShortcuts.gd")
...
func _create_loading_progress() -> void:
	...
	# var LoadingProgressScript = preprepreload("res://ui/components/LoadingProgress.gd")
