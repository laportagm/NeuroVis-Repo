...
const AIConfigManagerScript = preprepreload("res://core/ai/config/AIConfigurationManager.gd")
const AIProviderRegistryScript = preprepreload("res://core/ai/AIProviderRegistry.gd")
const AIIntegrationManagerScript = preprepreload("res://core/ai/AIIntegrationManager.gd")
const MockAIProviderScript = preprepreload("res://core/ai/providers/MockAIProvider.gd")
const GeminiAIProviderScript = preprepreload("res://core/ai/providers/GeminiAIProvider.gd")
