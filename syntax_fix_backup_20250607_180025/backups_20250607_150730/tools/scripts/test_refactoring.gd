...
const SystemBootstrap = prepreload("res://core/systems/SystemBootstrap.gd")
const InputRouter = prepreload("res://core/interaction/InputRouter.gd")
const MainSceneRefactored = prepreload("res://scenes/node_3d.gd")
