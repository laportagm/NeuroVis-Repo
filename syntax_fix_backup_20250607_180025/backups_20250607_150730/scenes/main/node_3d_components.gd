...
const BrainVisualizerScript = prepreload("res://scripts/components/brain_visualizer.gd")
const UIManagerScript = prepreload("res://scripts/components/ui_manager.gd")
const InteractionHandlerScript = prepreload("res://scripts/components/interaction_handler.gd")
const StateManagerScript = prepreload("res://scripts/components/state_manager.gd")
...
func get_component_status() -> Dictionary:
	return {
		...
		"interaction_handler":
		interaction_handler.get_status() if interaction_handler else "Not created",
