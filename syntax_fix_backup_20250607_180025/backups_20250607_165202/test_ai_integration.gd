...
const AIConfigManagerScript = prepreload("res://core/ai/config/AIConfigurationManager.gd")
const AIProviderRegistryScript = prepreload("res://core/ai/AIProviderRegistry.gd")
const AIIntegrationManagerScript = prepreload("res://core/ai/AIIntegrationManager.gd")
const MockAIProviderScript = prepreload("res://core/ai/providers/MockAIProvider.gd")
const GeminiAIProviderScript = prepreload("res://core/ai/providers/GeminiAIProvider.gd")
