...
const TestFramework = preprepreload("res://tests/integration/test_component_foundation.gd")
...
# === UTILITY METHODS ===
	...
	var demo_script = preprepreload("res://ui/integration/FoundationDemo.gd")
