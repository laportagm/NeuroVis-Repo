...
var test_results = []
	...
	vbox.add_child(button_container)
		...
		var config_script = preload("res://core/ai/config/AIConfigurationManager.gd")
		if config_script:
		...
		var registry_script = preload("res://core/ai/AIProviderRegistry.gd")
		if registry_script:
	...
	var mock_script = preload("res://core/ai/providers/MockAIProvider.gd")
	if mock_script:
